...
from RecSysFramework.Recommender.Recommender import Recommender
from RecSysFramework.Recommender.KNN.ItemKNNCustomSimilarityRecommender import ItemKNNCustomSimilarityRecommender
...
class BaseMatrixFactorizationRecommender(Recommender):
    ...
    def save_model(self, folder_path, file_name = None):
        ...
        data_dict_to_save = {"USER_factors": self.USER_factors,
                              ...
                              "_cold_user_KNN_model_available": self._cold_user_KNN_model_available}
