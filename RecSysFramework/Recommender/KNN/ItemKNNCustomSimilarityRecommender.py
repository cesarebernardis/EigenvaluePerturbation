...
from RecSysFramework.Recommender.Utils import check_matrix, similarityMatrixTopK
from RecSysFramework.Recommender.SimilarityMatrixRecommender import SimilarityMatrixRecommender


class ItemKNNCustomSimilarityRecommender(SimilarityMatrixRecommender):
    """ ItemKNN recommender"""
