...
class Holdout(DataSplitter):
    ...
    def __init__(self, train_perc=0.8, validation_perc=0.0, test_perc=0.2, forbid_new_split=False,
                 force_new_split=False, allow_cold_users=False, random_seed=42):
        """
    ...
    def get_name(self):
        return "holdout_{:.2f}_{:.2f}_{:.2f}{}".format(self.train_perc, self.validation_perc, self.test_perc,
...
class ColdItemsHoldout(DataSplitter):
    ...
    def get_name(self):
        return "colditems_holdout_{:.2f}_{:.2f}_{:.2f}{}".format(self.train_perc, self.validation_perc, self.test_perc,
                                                       "" if self.allow_cold_users else "_no_cold_users")
