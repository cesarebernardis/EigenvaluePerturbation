...
class KCore(DatasetPostprocessing):
    ...
    def __init__(self, user_k_core, item_k_core, reshape=True):
        ...
        assert user_k_core >= 1,\
            "DatasetPostprocessing - KCore: user_k_core must be a positive value >= 1, provided value was {}"\
            .format(user_k_core)

        assert item_k_core >= 1,\
            "DatasetPostprocessing - KCore: item_k_core must be a positive value >= 1, provided value was {}"\
            .format(item_k_core)
